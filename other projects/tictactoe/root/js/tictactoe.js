$(document).ready(function() {
  ...
  var circleOrEx = "o"; //first player is o. O goes first
  var isGameInProgress = true; // THe game is in progress
  var winningCombos = { // This shows that the board is a combo of 9 squares and its started
    0: [ //0 is key
